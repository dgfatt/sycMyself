...
public class UploadFile {
	...
	public UploadFile(String serverUrl, String filePath) {	
	...
	public String submit() {
		...
		try {
			...
			ds.writeBytes("Content-Disposition: form-data; " + "name=\"file\";filename=\"" + "camera.jpg" + "\"" + end);
			ds.writeBytes(end);
			/* 取得文件的FileInputStream */
			String uploadFile = this.filePath;
			...
			/* 显示网页响应内容 */
			// b.toString().trim()
			//Log.e("UploadFile", b.toString().trim());
